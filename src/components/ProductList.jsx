        ...
        <div className='mt-5'>
            <div className="flex flex-col gap-3 md:flex-row md:justify-between md:items-center mb-3">
                <div className="">
                    <div className="max-w-md mx-auto">
                        <label htmlFor="default-search"
                               className="mb-2 text-sm font-medium text-stone-900 sr-only">Search</label>
                ...
                <div className="ms-auto">
                    <Link to={'/product/create'} type="button"
                          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4font-medium rounded-lg text-sm p-4 me-2 mb-2 focus:outline-none flex justify-between items-center gap-3">Add
                        New Product <HiPlus className="size-5"/></Link>
                </div>
            </div>
