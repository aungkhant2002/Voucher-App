        ...
        <div className='mt-5'>
            <div className="flex flex-col gap-3 md:flex-row md:justify-between md:items-center mb-3">
                ...
                <div className="ms-auto">
                    <Link to={"/sale"} type="button"
                          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4font-medium rounded-lg text-sm p-4 me-2 mb-2 focus:outline-none flex justify-between items-center gap-3">Create
                        Sale <HiComputerDesktop className="size-5"/></Link>
                </div>
            </div>
