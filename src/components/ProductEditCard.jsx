...
const ProductEditCard = () => {
    ...
    return (
        <div className="w-full md:w-1/2 mt-5">
            ...
            <p className='text-stone-500'>Update the fields below to modify the existing product information in your
                store.</p>
                ...
                (
                    <form onSubmit={handleSubmit(handleEditProduct)} className='mt-10'>
                        ...
                        <div className='mb-3'>
                            ...
                            })} defaultValue={data.product_name} id="name"
                        ...
                        <div className='mb-5'>
                            ...
                            })} defaultValue={data.price} id="price"
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <label htmlFor="all-correct" className="ms-2 text-sm font-medium text-gray-900">Make sure
                                all field are correct</label>
                        </div>

                        <div className="flex items-center mb-4">
                            <input {...register("back_to_product_list")} checked id="back-to-product-list"
                                   type="checkbox" defaultValue
                                   className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm "/>
                            <label htmlFor="back-to-product-list" className="ms-2 text-sm font-medium text-gray-900">Back
                                to product list after saving</label>
                        </div>
